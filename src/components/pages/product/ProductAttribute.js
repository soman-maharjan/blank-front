    ...
    const inputFields = attribute.map((name, index) =>
        <div className="flex flex-wrap -mx-3 mb-6" key={index}>
            <div className="w-full px-3 mb-6 md:mb-0">
                ...
                <input name={name} onChange={changeHandler} className="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" />
            </div>
        </div>
    )
    return (
