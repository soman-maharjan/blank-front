    ...
    axios
      ...
      .then((response) => {
        ...
        showNotification({
          ...
          message: p[0].is_active
            ? "The product is visible to the customers!"
            : "The product is hidden from the customers!",
  ...
  const value = (column, row) => {
    switch (column.id) {
      case "options":
        return (
          <>
            ...
            <a
              onClick={() =>
                props.changePage({ page: "view-product", product: row })
              }
              className="normal-case mr-2 min-h-0 h-8 w-16 btn btn-ghost btn-sm rounded-btn bg-blue-500 hover:bg-blue-600 text-white"
            >
              <svg
            ...
            <a
              ...
              className="normal-case min-h-0 h-8 w-16 btn btn-ghost btn-sm rounded-btn bg-red-500 hover:bg-red-600 text-white"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
      ...
      case "visibility":
        return (
          <input
            onChange={() => statusHandler(row._id)}
            type="checkbox"
      ...
      <div class="text-sm breadcrumbs mt-3 flex">
        ...
        <div className="w-1/2 text-right">
          <div className="px-2 mx-2 ">
            <a
              className="btn btn-ghost btn-sm rounded-btn bg-green-300 text-green-700 hover:bg-green-400"
