        ...
        <div className="w-11/12">
            ...
            >
                {({
                    ...
                    <div
                        className="upload__image-wrapper border-blue-400 border-2 border-dotted bg-blue-100 p-10 mb-3 min-h-0" {...dragProps}>
                        <button
                        ...
                        <button onClick={onImageRemoveAll}
                                className="bg-red-300 text-black font-normal p-2 rounded m-1 cursor-pointer btn border-none min-h-0 h-10 hover:none hover:bg-red-500">Remove
                            all images
                        </button>
